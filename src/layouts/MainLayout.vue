  ...
  <div class="flex h-screen bg-gray-100 overflow-hidden">
    ...
    >
      <div class="flex items-center justify-between h-16 px-6 bg-blue-600">
        <RouterLink to="/dashboard" @click="isSidebarOpen = false" class="flex items-center h-16 hover:bg-blue-700 transition cursor-pointer">
          <span class="text-white text-xl font-bold tracking-wider">CLASSROOM SYNC</span>
        </RouterLink>
...
<style scoped>
/* การตั้งค่า CSS ส่วนเสริม (ใช้ Tailwind เป็นหลักอยู่แล้ว) */
.router-link-active {
